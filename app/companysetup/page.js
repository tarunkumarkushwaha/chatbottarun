...
const CompanySetup = () => {
  ...
  return (
    <div className="p-4 m-2 rounded-lg max-w-3xl mx-auto bg-gray-100 min-h-screen transform transition-all duration-300 animate-modalEnter">
      <div className="bg-white shadow rounded-lg p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <UiInput placeholder="Website URL" value={url} change={(e) => setUrl(e.target.value)} />
          <button
          ...
          >
            {LoadingMeta ? "please wait" : "Fetch Data"}
          </button>
          ...
          <div className="bg-white overflow-y-auto max-h-[80vh] rounded-2xl shadow-2xl w-full max-w-md p-6 transform transition-all duration-300 animate-modalEnter">
            ...
            <ul className="space-y-3">
              {selectedPage.chunks.map((chunk, index) => (
                <li
                  key={index}
                  className="p-3 border rounded-lg bg-gray-50 transition duration-300 hover:bg-gray-100"
                >
                  {chunk}
                </li>
              ))}
            ...
            <div className="mt-6 flex justify-end">
              <button
                className="bg-indigo-500 hover:bg-indigo-600 text-white px-5 py-2 rounded-lg transition duration-300"
